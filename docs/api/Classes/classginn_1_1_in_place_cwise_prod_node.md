# ginn::InPlaceCwiseProdNode


 [More...](#detailed-description)

Inherits from [ginn::CwiseProdNode< Scalar >](api/Classes/classginn_1_1_cwise_prod_node.md), [ginn::BaseDataNode< Scalar >](api/Classes/classginn_1_1_base_data_node.md), [ginn::Node< Real >](api/Classes/classginn_1_1_node.md), [ginn::BaseNode](api/Classes/classginn_1_1_base_node.md)
...
| virtual const [Tensor](api/Classes/classginn_1_1_tensor.md)< Scalar > & | **[grad](api/Classes/classginn_1_1_in_place_cwise_prod_node.md#function-grad)**() const override |
...
class ginn::InPlaceCwiseProdNode;
```
...
**Reimplements**: [ginn::CwiseProdNode::name](api/Classes/classginn_1_1_cwise_prod_node.md#function-name)
...
**Reimplements**: [ginn::CwiseProdNode::backward_](api/Classes/classginn_1_1_cwise_prod_node.md#function-backward_)

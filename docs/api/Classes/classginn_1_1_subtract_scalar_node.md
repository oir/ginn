...
|                | Name           |
| -------------- | -------------- |
| template <typename LeftScalar ,typename  =std::enable_if_t<ginn::is_arithmetic_v<LeftScalar>>\> <br>| **[SubtractScalarNode](api/Classes/classginn_1_1_subtract_scalar_node.md#function-subtractscalarnode)**(LeftScalar a, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & b) |
| virtual std::string | **[name](api/Classes/classginn_1_1_subtract_scalar_node.md#function-name)**() const override |
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[forward_](api/Classes/classginn_1_1_subtract_scalar_node.md#function-forward_)**() override |
| virtual void | **[backward_](api/Classes/classginn_1_1_subtract_scalar_node.md#function-backward_)**() override |
...
|                | Name           |
| -------------- | -------------- |
| [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > | **[in_](api/Classes/classginn_1_1_subtract_scalar_node.md#variable-in_)**  |
| Scalar | **[val_](api/Classes/classginn_1_1_subtract_scalar_node.md#variable-val_)**  |

...
Inherited by [ginn::InPlacePermuteNode< Scalar >](api/Classes/classginn_1_1_in_place_permute_node.md)
...
```cpp
template <Size N>
inline void forward_helper()
```


### function backward_helper

```cpp
template <Size N>
inline void backward_helper()
```

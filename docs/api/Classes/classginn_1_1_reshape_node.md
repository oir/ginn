...
|                | Name           |
| -------------- | -------------- |
| using std::vector< [DimPtr](api/Classes/classginn_1_1_ptr.md) > | **[LazyShape](api/Classes/classginn_1_1_reshape_node.md#using-lazyshape)**  |
...
|                | Name           |
| -------------- | -------------- |
| | **[ReshapeNode](api/Classes/classginn_1_1_reshape_node.md#function-reshapenode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > in, Shape s) |
| | **[ReshapeNode](api/Classes/classginn_1_1_reshape_node.md#function-reshapenode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, const LazyShape & s) |
| virtual bool | **[has_grad](api/Classes/classginn_1_1_reshape_node.md#function-has_grad)**() const override |
| virtual void | **[init_grad](api/Classes/classginn_1_1_reshape_node.md#function-init_grad)**() override |
| virtual std::string | **[name](api/Classes/classginn_1_1_reshape_node.md#function-name)**() const override |
...
```cpp
using ginn::ReshapeNode< Scalar >::LazyShape =  std::vector<DimPtr>;
```

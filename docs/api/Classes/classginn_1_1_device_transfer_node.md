...
|                | Name           |
| -------------- | -------------- |
| | **[DeviceTransferNode](api/Classes/classginn_1_1_device_transfer_node.md#function-devicetransfernode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > e, DevPtr dev) |
| virtual bool | **[has_grad](api/Classes/classginn_1_1_device_transfer_node.md#function-has_grad)**() const override |
| virtual std::string | **[name](api/Classes/classginn_1_1_device_transfer_node.md#function-name)**() const override |
...
class ginn::DeviceTransferNode;
```

## Public Functions Documentation

### function DeviceTransferNode

```cpp
inline DeviceTransferNode(
    NodePtr< Scalar > e,
    DevPtr dev
)
```

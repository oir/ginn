...
|                | Name           |
| -------------- | -------------- |
| | **[ChipNode](api/Classes/classginn_1_1_chip_node.md#function-chipnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & x, Size offset, Size dim) |
| virtual std::string | **[name](api/Classes/classginn_1_1_chip_node.md#function-name)**() const override |

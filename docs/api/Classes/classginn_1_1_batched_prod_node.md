...
|                | Name           |
| -------------- | -------------- |
| | **[BatchedProdNode](api/Classes/classginn_1_1_batched_prod_node.md#function-batchedprodnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & a, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & b) |
| virtual std::string | **[name](api/Classes/classginn_1_1_batched_prod_node.md#function-name)**() const override |
...
class ginn::BatchedProdNode;
```

## Public Functions Documentation

### function BatchedProdNode

```cpp
inline BatchedProdNode(

...
|                | Name           |
| -------------- | -------------- |
| template <typename RhsScalar \> <br>| **[MaskNode](api/Classes/classginn_1_1_mask_node.md#function-masknode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & mask, RhsScalar mask_val) |
| virtual std::string | **[name](api/Classes/classginn_1_1_mask_node.md#function-name)**() const override |

...
|                | Name           |
| -------------- | -------------- |
| | **[SelectNode](api/Classes/classginn_1_1_select_node.md#function-selectnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< bool > & if_n, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & then_n, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & else_n) |
| | **[SelectNode](api/Classes/classginn_1_1_select_node.md#function-selectnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< bool > & if_n, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & then_n, Scalar else_val) |
| | **[SelectNode](api/Classes/classginn_1_1_select_node.md#function-selectnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< bool > & if_n, Scalar then_val, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & else_n) |
| | **[SelectNode](api/Classes/classginn_1_1_select_node.md#function-selectnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< bool > & if_n, Scalar then_val, Scalar else_val) |
| virtual std::string | **[name](api/Classes/classginn_1_1_select_node.md#function-name)**() const override |

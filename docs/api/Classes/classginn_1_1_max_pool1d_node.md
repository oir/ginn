...
|                | Name           |
| -------------- | -------------- |
| | **[MaxPool1dNode](api/Classes/classginn_1_1_max_pool1d_node.md#function-maxpool1dnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > input, size_t len, size_t stride =1) |
| virtual std::string | **[name](api/Classes/classginn_1_1_max_pool1d_node.md#function-name)**() const override |

...
|                | Name           |
| -------------- | -------------- |
| | **[MeanNode](api/Classes/classginn_1_1_mean_node.md#function-meannode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in) |
| virtual std::string | **[name](api/Classes/classginn_1_1_mean_node.md#function-name)**() const override |

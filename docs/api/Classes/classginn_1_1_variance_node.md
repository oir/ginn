...
|                | Name           |
| -------------- | -------------- |
| | **[VarianceNode](api/Classes/classginn_1_1_variance_node.md#function-variancenode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in) |
| virtual std::string | **[name](api/Classes/classginn_1_1_variance_node.md#function-name)**() const override |
...
class ginn::VarianceNode;
```

## Public Functions Documentation

### function VarianceNode

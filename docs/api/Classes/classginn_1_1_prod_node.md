...
|                | Name           |
| -------------- | -------------- |
| | **[ProdNode](api/Classes/classginn_1_1_prod_node.md#function-prodnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & a, const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & b) |
| virtual void | **[set_ins](api/Classes/classginn_1_1_prod_node.md#function-set_ins)**(const std::vector< [BaseNodePtr](api/Classes/classginn_1_1_ptr.md) > & ins) override |
| virtual std::string | **[name](api/Classes/classginn_1_1_prod_node.md#function-name)**() const override |

...
|                | Name           |
| -------------- | -------------- |
| | **[MaxPool2dNode](api/Classes/classginn_1_1_max_pool2d_node.md#function-maxpool2dnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > input, size_t a_rows, size_t a_cols, size_t a_row_stride =1, size_t a_col_stride =1) |
| virtual std::string | **[name](api/Classes/classginn_1_1_max_pool2d_node.md#function-name)**() const override |

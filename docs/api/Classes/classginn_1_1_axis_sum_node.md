...
|                | Name           |
| -------------- | -------------- |
| | **[AxisSumNode](api/Classes/classginn_1_1_axis_sum_node.md#function-axissumnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, std::vector< Size > axes) |
| virtual std::string | **[name](api/Classes/classginn_1_1_axis_sum_node.md#function-name)**() const override |
...
class ginn::AxisSumNode;
```

## Public Functions Documentation

### function AxisSumNode

```cpp
inline AxisSumNode(
    const NodePtr< Scalar > & in,
    std::vector< Size > axes
)
```

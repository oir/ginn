...
|                | Name           |
| -------------- | -------------- |
| | **[RankViewNode](api/Classes/classginn_1_1_rank_view_node.md#function-rankviewnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > in, Size rank) |
| virtual bool | **[has_grad](api/Classes/classginn_1_1_rank_view_node.md#function-has_grad)**() const override |
| virtual void | **[init_grad](api/Classes/classginn_1_1_rank_view_node.md#function-init_grad)**() override |
| virtual std::string | **[name](api/Classes/classginn_1_1_rank_view_node.md#function-name)**() const override |
...
class ginn::RankViewNode;
```

## Public Functions Documentation

### function RankViewNode

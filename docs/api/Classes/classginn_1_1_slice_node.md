...
|                | Name           |
| -------------- | -------------- |
| | **[SliceNode](api/Classes/classginn_1_1_slice_node.md#function-slicenode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & x, Shape offsets, Shape sizes) |
| virtual std::string | **[name](api/Classes/classginn_1_1_slice_node.md#function-name)**() const override |

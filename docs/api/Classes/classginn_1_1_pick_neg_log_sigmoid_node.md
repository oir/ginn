...
|                | Name           |
| -------------- | -------------- |
| | **[PickNegLogSigmoidNode](api/Classes/classginn_1_1_pick_neg_log_sigmoid_node.md#function-pickneglogsigmoidnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, const [DataPtr](api/Classes/classginn_1_1_ptr.md)< Int > & index) |
| | **[PickNegLogSigmoidNode](api/Classes/classginn_1_1_pick_neg_log_sigmoid_node.md#function-pickneglogsigmoidnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, const std::vector< Int > & index) |
| | **[PickNegLogSigmoidNode](api/Classes/classginn_1_1_pick_neg_log_sigmoid_node.md#function-pickneglogsigmoidnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in, Int index) |
| virtual std::string | **[name](api/Classes/classginn_1_1_pick_neg_log_sigmoid_node.md#function-name)**() const override |
...
class ginn::PickNegLogSigmoidNode;
```

## Public Functions Documentation

### function PickNegLogSigmoidNode

```cpp
inline PickNegLogSigmoidNode(

...
|                | Name           |
| -------------- | -------------- |
| template <typename BiasScalar  =Scalar\> <br>| **[CwiseProdAddNode](api/Classes/classginn_1_1_cwise_prod_add_node.md#function-cwiseprodaddnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > a, [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > b, [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > c, BiasScalar multiplier_bias =BiasScalar(0)) |
| virtual std::string | **[name](api/Classes/classginn_1_1_cwise_prod_add_node.md#function-name)**() const override |
...
class ginn::CwiseProdAddNode;
```

## Public Functions Documentation

### function CwiseProdAddNode

```cpp
template <typename BiasScalar  =Scalar>
inline CwiseProdAddNode(
    NodePtr< Scalar > a,
    NodePtr< Scalar > b,
    NodePtr< Scalar > c,
    BiasScalar multiplier_bias =BiasScalar(0)

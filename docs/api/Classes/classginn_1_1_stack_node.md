...
|                | Name           |
| -------------- | -------------- |
| | **[StackNode](api/Classes/classginn_1_1_stack_node.md#function-stacknode)**(const std::vector< std::vector< [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > > > & nodes) |
| virtual std::string | **[name](api/Classes/classginn_1_1_stack_node.md#function-name)**() const override |
...
```cpp
inline StackNode(
    const std::vector< std::vector< NodePtr< Scalar > > > & nodes
)
```

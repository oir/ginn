...
|                | Name           |
| -------------- | -------------- |
| | **[RowBroadcastNode](api/Classes/classginn_1_1_row_broadcast_node.md#function-rowbroadcastnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > in, [DimPtr](api/Classes/classginn_1_1_ptr.md) rows) |
| | **[RowBroadcastNode](api/Classes/classginn_1_1_row_broadcast_node.md#function-rowbroadcastnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > in, Size rows) |
| virtual std::string | **[name](api/Classes/classginn_1_1_row_broadcast_node.md#function-name)**() const override |
...
class ginn::RowBroadcastNode;
```

## Public Functions Documentation

### function RowBroadcastNode

```cpp
inline RowBroadcastNode(
    NodePtr< Scalar > in,
    DimPtr rows
)
```

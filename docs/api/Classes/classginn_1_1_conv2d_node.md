...
|                | Name           |
| -------------- | -------------- |
| | **[Conv2dNode](api/Classes/classginn_1_1_conv2d_node.md#function-conv2dnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > input, [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > filters, size_t a_row_stride =1, size_t a_col_stride =1) |
| virtual std::string | **[name](api/Classes/classginn_1_1_conv2d_node.md#function-name)**() const override |

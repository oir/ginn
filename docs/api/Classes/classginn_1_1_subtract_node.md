...
|                | Name           |
| -------------- | -------------- |
| | **[SubtractNode](api/Classes/classginn_1_1_subtract_node.md#function-subtractnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > a, [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > b) |
| virtual std::string | **[name](api/Classes/classginn_1_1_subtract_node.md#function-name)**() const override |

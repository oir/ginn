...
Inherits from [ginn::Node< Scalar >](api/Classes/classginn_1_1_node.md), [ginn::BaseNode](api/Classes/classginn_1_1_base_node.md)
...
|                | Name           |
| -------------- | -------------- |
| | **[DeviceViewNode](api/Classes/classginn_1_1_device_view_node.md#function-deviceviewnode)**([NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > e, DevPtr dev) |
| virtual DevPtr | **[dev](api/Classes/classginn_1_1_device_view_node.md#function-dev)**() const override |
| virtual const [Tensor](api/Classes/classginn_1_1_tensor.md)< Scalar > & | **[value](api/Classes/classginn_1_1_device_view_node.md#function-value)**() const override |
| virtual const [Tensor](api/Classes/classginn_1_1_tensor.md)< Scalar > & | **[grad](api/Classes/classginn_1_1_device_view_node.md#function-grad)**() const override |
| virtual std::string | **[name](api/Classes/classginn_1_1_device_view_node.md#function-name)**() const override |
...
**Public Types inherited from [ginn::Node< Scalar >](api/Classes/classginn_1_1_node.md)**
...
**Public Functions inherited from [ginn::Node< Scalar >](api/Classes/classginn_1_1_node.md)**
...
class ginn::DeviceViewNode;
```

## Public Functions Documentation

### function DeviceViewNode

```cpp
inline DeviceViewNode(
    NodePtr< Scalar > e,
    DevPtr dev
)
```

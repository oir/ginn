...
|                | Name           |
| -------------- | -------------- |
| | **[SumNode](api/Classes/classginn_1_1_sum_node.md#function-sumnode)**(const [NodePtr](api/Classes/classginn_1_1_ptr.md)< Scalar > & in) |
| virtual void | **[set_ins](api/Classes/classginn_1_1_sum_node.md#function-set_ins)**(const std::vector< [BaseNodePtr](api/Classes/classginn_1_1_ptr.md) > & ins) override |
| virtual std::string | **[name](api/Classes/classginn_1_1_sum_node.md#function-name)**() const override |

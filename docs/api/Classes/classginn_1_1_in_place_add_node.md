...
Inherits from [ginn::AddNode< Scalar >](api/Classes/classginn_1_1_add_node.md), [ginn::BaseDataNode< Scalar >](api/Classes/classginn_1_1_base_data_node.md), [ginn::Node< Real >](api/Classes/classginn_1_1_node.md), [ginn::BaseNode](api/Classes/classginn_1_1_base_node.md)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| virtual const [Tensor](api/Classes/classginn_1_1_tensor.md)< Scalar > & | **[value](api/Classes/classginn_1_1_in_place_add_node.md#function-value)**() const override |
| virtual const [Tensor](api/Classes/classginn_1_1_tensor.md)< Scalar > & | **[grad](api/Classes/classginn_1_1_in_place_add_node.md#function-grad)**() const override |
| virtual bool | **[has_grad](api/Classes/classginn_1_1_in_place_add_node.md#function-has_grad)**() const override |
| virtual std::string | **[name](api/Classes/classginn_1_1_in_place_add_node.md#function-name)**() const override |

## Protected Functions

|                | Name           |
| -------------- | -------------- |
| virtual void | **[forward_](api/Classes/classginn_1_1_in_place_add_node.md#function-forward_)**() override |
| virtual void | **[backward_](api/Classes/classginn_1_1_in_place_add_node.md#function-backward_)**() override |

## Additional inherited members

**Public Functions inherited from [ginn::AddNode< Scalar >](api/Classes/classginn_1_1_add_node.md)**
...
**Protected Functions inherited from [ginn::AddNode< Scalar >](api/Classes/classginn_1_1_add_node.md)**
...
**Protected Attributes inherited from [ginn::AddNode< Scalar >](api/Classes/classginn_1_1_add_node.md)**
...
**Reimplements**: [ginn::AddNode::name](api/Classes/classginn_1_1_add_node.md#function-name)
...
**Reimplements**: [ginn::AddNode::forward_](api/Classes/classginn_1_1_add_node.md#function-forward_)
...
**Reimplements**: [ginn::AddNode::backward_](api/Classes/classginn_1_1_add_node.md#function-backward_)
